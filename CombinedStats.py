...
for parameters in parameter_list:
    ...
    for seed in seeds:
        try:
            df_temp=pd.read_csv('C:/GitHub/Collective-Decision-Making/all_results/Stats_{}_{}_{}_{}_{}.csv'.format(parameters[0],parameters[1],parameters[2],parameters[3],seed[0]))
            try:
...
df.to_csv('C:/GitHub/Collective-Decision-Making/all_results/mean_stde.csv')        