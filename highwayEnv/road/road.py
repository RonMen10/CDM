...
import pandas as pd
import logging
from highwayEnv.road.lane import LineType, StraightLane
...
class Road(object):
    ...
    def step(self, dt, agents, other_vehicles):
        """
    ...
    def getVehiclesInSector(self, _from, _to):
        self.road.network.get_lane((_from, _to, 0))
