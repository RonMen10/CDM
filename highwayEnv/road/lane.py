...
from highwayEnv.vehicles.control import Vehicle 
...
class StraightLane(AbstractLane):
    ...
    """
    def __init__(self, start, end, width=AbstractLane.DEFAULT_WIDTH, line_types=None, forbidden=False, speed_limit=30, priority=0):
        """
            New straight lane.
...
class CircularLane(AbstractLane):
    ...
    def local_coordinates(self, position):
        ...
        phi = self.start_phase + methods.wrap_to_pi(phi - self.start_phase)
