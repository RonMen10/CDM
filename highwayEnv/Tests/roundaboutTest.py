...
class RoundaboutEnv(gym.Env):
    ...
    def _is_terminal(self):
        ...
        if (self.total_attempts >= variables.test_terminal):
            return True, calculate_statistics(archive.get_archive(), self.cumulatedCrashes, self.cumulatedTime, self.risk_tol,
    ...
    def set_configuration(self, risk_tol,threshold_tol,hv_tol,sigma,seed):
        ...
        archive.set_archive(self.risk_tol,self.threshold_tol,self.hv_tol,self.sigma)
